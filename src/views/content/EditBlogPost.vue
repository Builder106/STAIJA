  ...
  <div class="edit-blog-post">
    <div class="header">
      <div class="header-info">
        ...
        <p class="subtitle">Make changes to your blog post</p>
      </div>
    ...
    <!-- Reuse the same editor template as NewBlogPost -->
        ...
        <div class="sidebar-section">
          ...
          <div class="status-options">
            ...
            <label class="status-option">
              ...
              <span class="status-desc">Hide post from readers</span>
            </label>
          </div>
        </div>
...
const savePost = async () => {
  try {
    const updates = {
      ...
      updatedAt: new Date(),
      publishDate: post.value.status === 'published' && !post.value.publishDate ? new Date() : post.value.publishDate
    }

    await DatabaseService.updateContentItem(post.value.id, updates)
...
const loadPost = async () => {
  ...
  try {
    const contentItems = await DatabaseService.getContentItems('blog', undefined)
    const postData = contentItems.find(item => item.id === postId)
...
/* Reuse styles from NewBlogPost.vue */
.editor-container {
  display: grid;
